<html>
  ...
  <body class="bg-pink-100 h-screen flex items-center justify-center">
    ...
    >
      ...
      <button type="button" class="w-full py-2 inline-flex items-center justify-center gap-x-2 text-sm font-medium rounded-full bg-gray-200 text-gray-500 mb-4" disabled="">
        Kirim ulang OTP
      </button>
      <!-- <button
