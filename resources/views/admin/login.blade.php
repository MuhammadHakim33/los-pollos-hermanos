    ...
    <div
      ...
      <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <!-- ====== Forms Section Start -->
          <div
            class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mt-16">
              ...
              <div
                ...
                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                  ...
                  <form method="POST" action="{{ route('loginAdmin') }}">
                    ...
                    <div class="mb-5">
                      <button class="w-full cursor-pointer rounded-lg border border-primary bg-blue-500 p-4 font-medium text-white transition hover:bg-opacity-90"> Log in </button>
                    </div>
                  </form>
                </div>
              </div>
